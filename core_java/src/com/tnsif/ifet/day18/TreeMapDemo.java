...
public class TreeMapDemo {
	...
	public static void main(String[] args) {
		...
		students.put(new Student(101, "Barath", 67), "TY");
		students.put(new Student(102, "Sathish", 72), "FY");
		students.put(new Student(104, "Chan", 71), "SY");
		students.put(new Student(103, "Kesavan", 87), "BE");
